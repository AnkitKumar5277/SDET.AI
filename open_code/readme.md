...
- OpenCode is an **open-source AI coding agent** designed for use in the terminal. Unlike proprietary tools
- AI coding assistant / developer workflow tool used to analyze codebases, generate tests, and automate development tasks
...
- run opencode: opencode test-gen add.py
- opencode explain src/main.py
- Find Bugs: opencode analyze
...
<img width="431" height="225" alt="image" src="https://github.com/user-attachments/assets/1a043f83-fcc4-4cb0-bc2c-89dca032f688" />
